...
public class Header: NSObject {
    ...
    public func v2Header(method: method, uri: String, secretKey: String, apiKey: String) -> HTTPHeaders {
    ...
    private func makeV2Signature(method: String, uri: String, timestamp: String, secretKey: String, accesskey: String) -> String {
        let space = " "
        let newLine = "\n"
